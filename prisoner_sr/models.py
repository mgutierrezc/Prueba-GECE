...
class Player(BasePlayer):
    ...
    def set_payoff(self):
        ...
        payoff_matrix = {
            'Cooperate':
                {
                    'Cooperate': Constants.both_cooperate_payoff + (self.round_number-1)*0.1,
                    'Defect': Constants.betrayed_payoff + (self.round_number-1)*0.1
                },
            'Defect':
                {
                    'Cooperate': Constants.betray_payoff + (self.round_number-1)*0.1,
                    'Defect': Constants.both_defect_payoff + (self.round_number-1)*0.1
                }
        }
